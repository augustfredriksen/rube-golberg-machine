...
async function createGolfCourseParts(groupMesh, compoundShape) {
	...
	loader.load("fonts/gentilis.json", async (font) => {
		...
		textMesh.position.set(
			wallMeshLeft.position.x,
			wallMeshLeft.position.y + wallMeshLeft.geometry.parameters.height / 2,
			wallMeshLeft.position.z
		);
	...
	shortWallBackMesh.position.set(
		shortWallBackMesh.position.x,
		shortWallBackMesh.position.y,
		-shortWallBackMesh.position.z
	);
