...
export async function createAmmoSpringBoard(width = 1, length = .1, depth = 3, mass = 10 ,rotation={x: 0, y: 0, z: 0}, position= {x: 0, y: 7, z: -24.8}) {
	let isCollided = false;
    let materials = await createMaterials();
    let sphere = createAmmoSphere(
        {x: 0, y: 0, z: 0},
        {x: 0, y: 7.4, z: -23.5},
        materials.brickMaterial
    );
