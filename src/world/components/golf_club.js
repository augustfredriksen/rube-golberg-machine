...
export const hingedGolfClub = async () => {
	const golfClub = await createAmmoGolfClub();
	const rigidGolfClub = await getRigidBodyFromMesh("golfclub");
...
function createAnchor(position = { x: 0.1806, y: 11.8, z: -1 }) {
	const radius = 0.2;
	const mass = 0;
